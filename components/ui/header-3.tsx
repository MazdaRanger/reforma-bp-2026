			...
			<nav className="mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-4">
				<div className="flex items-center gap-5">
					...
					<NavigationMenu className="hidden md:flex">
						<NavigationMenuList>
							<NavigationMenuItem>
								<NavigationMenuTrigger className="bg-transparent">Modul Sistem</NavigationMenuTrigger>
							...
							<NavigationMenuItem>
								<NavigationMenuTrigger className="bg-transparent">Laporan & Finance</NavigationMenuTrigger>
			...
			<MobileMenu open={open} className="flex flex-col justify-between gap-2 overflow-y-auto">
				<NavigationMenu className="max-w-full">
					<div className="flex w-full flex-col gap-y-2">
						<span className="text-sm">Modul Sistem</span>
				...
				<div className="flex flex-col gap-2">
					...
					<Button className="w-full">Dashboard Utama</Button>
				</div>
			</MobileMenu>
		</header>
	);
...
const productLinks: LinkItem[] = [
	{
		title: 'Pendaftaran Unit',
		href: '#',
		description: 'Input Data Unit Baru ke Sistem',
		icon: Car,
	},
	{
		title: 'Daftar Pekerjaan (WO)',
		href: '#',
		description: 'Kelola SPK dan Work Order berjalan',
		icon: Layers,
	},
	{
		title: 'Papan Kontrol',
		href: '#',
		description: 'Monitoring progress perbaikan unit',
		icon: LineChart,
	},
	{
		title: 'Gudang & Inventory',
		href: '#',
		description: 'Pantau stok part dan material',
		icon: Box,
	},
	{
		title: 'Customer Relation (CRC)',
		href: '#',
		description: 'Booking, feedback, dan keluhan pelanggan',
		icon: Headset,
	},
	{
		title: 'General Affairs',
		href: '#',
		description: 'Manajemen aset dan operasional',
		icon: Shield,
	},
];
...
const financeLinks: LinkItem[] = [
	...
	},
	{
		...
		href: '#',
		description: 'Manajemen hutang piutang asuransi/pribadi',
		icon: PieChart,
	},
	{
		...
		href: '#',
		icon: FileText,
		description: 'Buat tagihan resmi untuk asuransi dan pelanggan',
	},
];
